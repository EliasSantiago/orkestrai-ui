...
import { enableCustomAuth, enableNextAuth } from '@/const/auth';
...
const StoreInitialization = memo(() => {
  ...
  // Load agents from backend when using custom auth
  ...
  // Load agents from backend when using custom auth and user is logged in
  useEffect(() => {
