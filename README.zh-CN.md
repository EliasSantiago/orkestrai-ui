...
<h1>Custom LobeChat</h1>

定制版 ChatGPT/LLMs 聊天应用，集成自定义认证和API<br/>
支持语音合成、多模态、可扩展的插件系统<br/>
优化用于生产环境部署，支持 Docker 和 CI/CD 自动化

**定制生产版本** · 基于 [LobeChat](https://github.com/lobehub/lobe-chat)
